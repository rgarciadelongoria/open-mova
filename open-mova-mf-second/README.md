...
Segundo microfrontal de demostración de Open Mova. Es un proyecto Angular
...
La shell lo monta bajo `/second`, por lo que las URLs completas son:
...
El servidor de desarrollo utiliza el puerto `4400` y publica el artefacto
remoto en:

```text
http://localhost:4400/remoteEntry.json
```
