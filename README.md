...
| ------------------------ | -------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------- |
| `@open-mova`             | `0.2.20` |                                                                                                                                                                                           | <a href="README.md"><img src="assets/icons/document.svg" alt="Documentación de Open Mova" width="18" height="18"></a>                 |
...
| `@open-mova/cli`         | `0.1.33` | <a href="https://www.npmjs.com/package/@open-mova/cli" target="_blank" rel="noopener noreferrer"><img src="https://cdn.simpleicons.org/npm/CB3837" alt="npm" width="20" height="20"></a>  | <a href="open-mova-cli/README.md"><img src="assets/icons/document.svg" alt="Documentación del CLI" width="18" height="18"></a>        |
...
| `@open-mova/mf-template` | `0.2.9`  |                                                                                                                                                                                           | <a href="open-mova-mf-template/README.md"><img src="assets/icons/document.svg" alt="Documentación del MF" width="18" height="18"></a> |
